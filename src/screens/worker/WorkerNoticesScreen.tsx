...
function makeStyles(theme: Theme) {
  return StyleSheet.create({
    ...
    allClearCard: { alignItems: 'center', backgroundColor: theme.successLight, borderColor: theme.success, borderRadius: 12, borderWidth: 1, flexDirection: 'row', gap: 12, marginBottom: 20, padding: 16 },
    allClearIcon: { color: theme.success, fontSize: 24 },
    allClearTitle: { color: theme.success, fontSize: 14, fontWeight: '900' },
