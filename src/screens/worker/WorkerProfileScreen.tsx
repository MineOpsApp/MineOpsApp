...
const styles = StyleSheet.create({
  ...
  pageTitle: { color: '#17212b', fontSize: 26, fontWeight: '900', marginBottom: 4 },
  pageSub: { color: '#5d6875', fontSize: 13, fontWeight: '600', marginBottom: 20 },
  ...
  profileName: { color: '#17212b', fontSize: 22, fontWeight: '900', marginBottom: 2 },
  profileMeta: { color: '#5d6875', fontSize: 13, fontWeight: '700', marginBottom: 12 },
  photoActions: { flexDirection: 'row', gap: 10 },
  photoBtn: { backgroundColor: '#17212b', borderRadius: 8, paddingHorizontal: 18, paddingVertical: 9 },
  photoBtnText: { color: '#ffffff', fontSize: 13, fontWeight: '800' },
  photoBtnAlt: { backgroundColor: '#fff5f5', borderColor: '#fca5a5', borderRadius: 8, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 9 },
  photoBtnAltText: { color: '#b42318', fontSize: 13, fontWeight: '800' },
  ...
  // ID card button
  idCardBtn: { alignItems: 'center', backgroundColor: '#fff', borderColor: '#dde3ea', borderRadius: 10, borderWidth: 1, flexDirection: 'row', gap: 12, marginBottom: 16, padding: 14 },
  ...
  sectionTitle: { color: '#17212b', fontSize: 14, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 0.5 },
  editLink: { color: '#1f6f5b', fontSize: 13, fontWeight: '800' },

  // Bio
  bioText: { color: '#17212b', fontSize: 14, fontWeight: '600', lineHeight: 22 },
  bioEmpty: { color: '#9aa5b1', fontSize: 13, fontWeight: '600' },
  bioInput: { backgroundColor: '#f4f6f8', borderColor: '#dde3ea', borderRadius: 8, borderWidth: 1, color: '#17212b', fontSize: 14, minHeight: 90, padding: 12 },
  bioCount: { color: '#9aa5b1', fontSize: 11, fontWeight: '700', marginTop: 4, textAlign: 'right' },
  bioActions: { flexDirection: 'row', gap: 10, marginTop: 10 },
  bioSaveBtn: { backgroundColor: '#1f6f5b', borderRadius: 8, paddingHorizontal: 20, paddingVertical: 9 },
  bioSaveBtnText: { color: '#fff', fontSize: 13, fontWeight: '800' },
  bioCancelBtn: { backgroundColor: '#f4f6f8', borderColor: '#dde3ea', borderRadius: 8, borderWidth: 1, paddingHorizontal: 16, paddingVertical: 9 },
  bioCancelBtnText: { color: '#5d6875', fontSize: 13, fontWeight: '800' },
  ...
  idCardNote: { color: '#9aa5b1', fontSize: 11, fontWeight: '600', textAlign: 'center' },
});
